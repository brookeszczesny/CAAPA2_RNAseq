...
output_path <- "/data/home/szczesnybm/CAAPA2_differential_expr_test/adult/"
...
pheno_withPC_path <-"/data/lad_gphs/CAAPA2_Transcriptomics_analysis/phenotype_data/27APR2022/asthma_active/pheno_Adult_n376_withPC.csv"


# Active asthma
raw_counts_path <- "/data/lad_gphs/CAAPA2_Transcriptomics_analysis/differential_expression_analysis/05MAY2022/active_asthma/adult_vs_ped/adult/Adult_n376__raw_counts.csv"

passed_genes_path <- "/data/lad_gphs/CAAPA2_Transcriptomics_analysis/differential_expression_analysis/05MAY2022/active_asthma/adult_vs_ped/adult/Adult_n376__21789_filtered_genes.csv"
