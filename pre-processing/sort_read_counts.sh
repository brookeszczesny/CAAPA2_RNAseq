...
time samtools sort -@ 8 -o /dcs04/mathias/data/CAAPA2_Transcriptomics/alignment/BAM/${id_name}_hisat2_hits_adaptertrimmed.bam /dcs04/mathias/data/CAAPA2_Transcriptomics/alignment/${id_name}_hisat2_hits_adaptertrimmed.sam
...
#-S /dcs04/mathias/data/CAAPA2_Transcriptomics/alignment/${id_name}_hisat2_hits_adaptertrimmed.sam
